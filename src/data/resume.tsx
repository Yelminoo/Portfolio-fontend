...
import { HomeIcon, NotebookIcon, DollarSignIcon } from "lucide-react";
...
export const DATA = {
  ...
  navbar: [
    ...
    { href: "/quotation", icon: DollarSignIcon, label: "Freelance" },
  ],
  contact: {
    ...
    social: {
      ...
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/yelmin-oo-bb8967236",
        icon: Icons.linkedin,
  ...
  education: [
    {
      school: "University of Medicine , Yangon",
      href: "https://um1yangon.edu.mm/",
      degree: "3rd Years of M.B.B.S",
      logoUrl: "/um1.png",
      start: "2016",
      end: "2020",
    },
    {
      school: "aci Learning (IT PRO)",
      href: "https://www.acilearning.com/itpro/",
      degree: "Comp-TIA IT Fundamental",
      logoUrl: "/aci.png",
      start: "2022",
      end: "2022",
    },
    ...
    {
      school: "Myanmar Computer Professional Associations",
  ...
  projects: [
    {
      ...
      image: "/aigmapte-site.png",
      video: "",
    },
    {
      title: "ISMART Academy",
      href: "https://smarteduglobe.com/",
      ...
      image: "/ismart-site.png",
      video: "",
    },
    {
      title: "Promptopia",
      href: "https://promptopia-xi-flax.vercel.app/",
    ...
    {
      title: "Aigma PTE Mobile",
      href: "https://play.google.com/store/apps/details?id=com.aigmamobile",
      dates: "April 2023 - March 2024",
      active: true,
      description:
