...
export async function BoxRevealDemo() {
  return (
    <div className="size-full w-100 gap-3 mt-20 flex  justify-center  pt-8 px-10 flex-wrap ">
      <div className={"w-[100%] flex mb-16 flex-col md:flex-row h-auto"}>
        <div className="w-[100%] md:w-[50%] h-auto mb-10">
              ...
              <div className=" text-gray-800">
                ...
                <div className=" pl-4">
                  <span className="font-semibold dark:text-white">
                    Crafting intuitive and responsive user interfaces using
        ...
        <div className="w-[100%] md:w-[50%]">
          <VideoBox src="/working-man.mp4" />
        </div>
      </div>
      <div className={"w-[100%] flex flex-col md:flex-row h-auto"}>
        <div className="w-[100%] md:w-[50%]">
          <VideoBox src="/computer-man.mp4" />
        </div>
        <div className="w-[100%] md:w-[50%]">
          <BoxReveal boxColor={"#5046e6"} duration={0.5}>
            <p className="text-[2.5rem] font-semibold dark:text-white">
          ...
          <BoxReveal boxColor={"#5046e6"} duration={0.5}>
            <div className="mt-6">
              <div className=" text-gray-800">
                ...
                <div className=" pl-4">
                  <span className="font-semibold dark:text-white">
                    Proficient in a wide range of web technologies and
                    frameworks. I have hands-on experience creating everything
                    from interactive frontend interfaces to secure backend
                    systems. My ability to work across the entire development
                    stack ensures seamless, well-integrated solutions.
                  </span>
                </div>
              </div>
            </div>
              ...
              <div className=" text-gray-800">
                ...
                <div className=" pl-4">
                  <span className="font-semibold dark:text-white">
                    ...
                    applications that prioritize the user experience. My
                    attention to detail ensures that your product will be not
          ...
          <BoxReveal boxColor={"#5046e6"} duration={0.5}>
            <div className="mt-6">
              <div className=" text-gray-800">
                ...
                <div className=" pl-4">
                  <span className="font-semibold dark:text-white">
                    With a background in working closely with teams and
                    customers, I understand the importance of clear
                    communication and collaboration. I love working on projects
                    that improve the lives of end users and take pride in
                    delivering value to both teams and clients.
                  </span>
                </div>
              </div>
            </div>
              ...
              <div className=" text-gray-800">
                ...
                <div className=" pl-4">
                  <span className="font-semibold dark:text-white">
                    ...
                    optimizing performance, ensuring cross-platform
                    compatibility, or resolving tough bugs. My approach is to
                    find elegant, scalable solutions that stand the test of
                    time.
                  </span>
                </div>
              </div>
