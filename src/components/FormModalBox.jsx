...
const FormModalBox = ({ isOpen, setIsOpen }) => {
  ...
  return (
    <>
      {isOpen && (
        <div className="fixed top-0 left-0 w-full h-full z-40 bg-gray-500/15 backdrop-blur-md animate-pulse-finite">
          <div className="fixed w-2/3 md:w-1/3  backdrop-blur-lg h-auto z-30 bg-gradient-to-r from-slate-500/7 via-gray-600/7 p-10 rounded-lg left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 shadow-lg">
